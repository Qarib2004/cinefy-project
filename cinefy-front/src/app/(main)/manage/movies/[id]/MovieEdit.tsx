				...
				{isLoading ? (
					...
					<>
						<div className={formStyles.fields}>
							<Field
								{...register('title', {
									required: 'НThe name is mandatory'
								})}
								placeholder='Name'
								error={errors.title}
							/>
							...
							<Controller
								...
								control={control}
								rules={{
									required: 'Please choose at least one actor'
								}}
								render={({ field, fieldState: { error } }) => (
									<Select
										error={error}
							...
							<Controller
								...
								rules={{
									required: 'A large poster is required'
								}}
							/>
							...
							<Controller
								...
								rules={{
									required: 'The video is mandatory'
								}}
							/>
						</div>
